...
export const MOCK_TICKETS: DashboardTicket[] = [
  {
    ...
    location: "DALAM_KOTA",
    category: "VIP",
    openedAt: new Date(DEMO_AS_OF.getTime() - 100 * 60 * 1000).toISOString(), // 1h40m → WARNING
    vendorName: "Vendor 1",
  ...
  },
  {
    ...
    location: "DALAM_KOTA",
    category: "NON_VIP",
    openedAt: new Date(DEMO_AS_OF.getTime() - 250 * 60 * 1000).toISOString(), // past 4h peak → BREACHED
    vendorName: "Vendor 1",
